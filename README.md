...
La base de datos de prácticas (tienda con clientes, productos y pedidos) está en el módulo 02 y en `SQL_Apuntes_99-Script-BBDD.sql`. Ejecútalo una vez y tendrás los datos listos para todos los ejercicios.
